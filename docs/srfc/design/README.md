...
|---|---|---|---|
| [pinboard-program.md](pinboard-program.md) | Announcement program — permissionless, stateless; emits opaque tagged `Note` events. | §5.5 | `SLNTPDxgFKwSZ31CbbdSKKHyRpBpKjEMYVj2gpGxkN2` (immutable) |
| [registry-program.md](registry-program.md) | Meta-address registry — maps a wallet pubkey → meta-address (ERC-6538 analog); optional. | §5.6 | `SLNTRCsjJXUQM3UbHjgJ48xe4GjKFSiLmrF1mXA8Vn2` (immutable) |
